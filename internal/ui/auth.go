...
func authHTML(vm AuthPage) string {
	...
	b.WriteString(`<meta name="description" content="Portal operasional Formora Taiwan.">`)
	...
	b.WriteString(`<div class="auth-brand"><div class="brand-mark" aria-hidden="true"><span></span></div><div><p>FORMORA</p><strong>Taiwan</strong></div></div>`)
