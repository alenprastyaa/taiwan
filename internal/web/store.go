...
type Store interface {
	...
	SubmitPaymentProof(ctx context.Context, viewer dashboard.User, code string, amount int64, note, fileName, storagePath string) (dashboard.Order, error)
	VerifyOrderPayment(ctx context.Context, viewer dashboard.User, paymentID string) (dashboard.Order, error)
	RejectOrderPayment(ctx context.Context, viewer dashboard.User, paymentID, reason string) (dashboard.Order, error)
	CreateManualInstallment(ctx context.Context, viewer dashboard.User, orderID string, amount int64, note string) (dashboard.Order, error)
	...
	DeleteStaff(ctx context.Context, viewer dashboard.User, staffID string) error
